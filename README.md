...
[latest - for quick experiments](http://bs-static.cdn.telerik.com/latest/everlive.images.min.js)
	...
	{{EverliveCdnUrl}} = https://bs1.cdn.telerik.com/image/v1/{YourApiKey}/
...
<pre class='javascript'><code>&lt;img data-src="http://www.your-site.com/images/image.jpg" /></code></pre>  
...
<pre class='javascript'><code>&lt;img data-src="{{PathToTheImage}}" class="resimgs" /></code></pre> 
